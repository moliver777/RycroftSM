class Event < ActiveRecord::Base
  ...
  SCHOOLING = "SCHOOLING"
  HOURSOFF = "HOURS OFF"
  TYPES = [INTRODUCTORY,WALKOUT,PRIVATE,SEMIPRIVATE,GROUP,GROUPHACK,BHS1,BHS2,BHS3,BHS4,PTT,LECTURE,LUNGING,SCHOOLING,HOURSOFF]
  GROUP_TYPES = [GROUP]
  BHS_TYPES = [BHS1,BHS2,BHS3,BHS4]
  HORSE = [INTRODUCTORY,WALKOUT,PRIVATE,SEMIPRIVATE,GROUP,GROUPHACK,BHS1,BHS2,BHS3,BHS4,PTT,LUNGING,SCHOOLING]
